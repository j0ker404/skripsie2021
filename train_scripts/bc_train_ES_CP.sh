...
echo "Generate Valid eps"
python ./other/cartpole/algs/imitate/episodes/gen_eps_cartpole_valid.py
echo "Stop Generate Valid eps"

echo "Start training"
python ./other/cartpole/algs/imitate/bc/train_ES.py
echo "Stop training"
